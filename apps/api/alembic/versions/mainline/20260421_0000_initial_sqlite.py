"""create sqlite initial data model
...
def upgrade() -> None:
    ...
    op.create_table(
        "parse_results",
        sa.Column("id", sa.String(length=36), primary_key=True, nullable=False),
        sa.Column("candidate_asset_id", sa.String(length=36), nullable=False),
        sa.Column("status", sa.String(length=64), nullable=False),
        sa.Column(
            "payload",
            sa.JSON(),
    ...
    op.create_table(
        "turn_assessments",
        sa.Column("id", sa.String(length=36), primary_key=True, nullable=False),
        sa.Column("interview_turn_id", sa.String(length=36), nullable=False),
